...
(PLEASE NOTE: This is just a fork of Kosace's work, and I only altered a section of code to fix the bug with reloading the item filter. All credit should goto Kosace for creation of this awesome application!)
